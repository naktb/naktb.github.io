...
angular.module('naktbApp.directives')
    .directive('fileread', ["$rootScope", "$window", function($rootScope, $window) {
      return {
        scope: {
          fileread: "="
        },
...
angular.module('naktbApp.services').factory('formHandler', ["$http", "formDataObject", "commonHelpers", function ($http, formDataObject, commonHelpers) {
